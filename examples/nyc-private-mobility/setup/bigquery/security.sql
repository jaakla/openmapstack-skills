...
--   * the analysis dataset is granted read-only; the restricted dataset is
--     granted nothing at all, so it stays inaccessible;
...
-- -- read-only on the analysis dataset ---------------------------------------
GRANT `roles/bigquery.dataViewer`
ON SCHEMA `:project`.`:dataset`
TO :'reader_principal';

-- -- and nothing on the restricted dataset -----------------------------------
